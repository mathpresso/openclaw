...
async function requireRiskAcknowledgement(params: {
  ...
  await params.prompter.note(
    [
      ...
      "",
      "LearnClaw is built on OpenClaw and still in beta. Expect sharp edges.",
      "By default, LearnClaw is a personal learning agent: one trusted operator boundary.",
      ...
      "",
      "If you’re not comfortable with security hardening and access control, don’t run LearnClaw.",
...
export async function runOnboardingWizard(
  ...
  await prompter.intro("LearnClaw onboarding");
